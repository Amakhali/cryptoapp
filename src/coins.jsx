...
const Coins = () => {
    ...
    useEffect(() => {
        ...
        axios.get(
            ...
            =usd&order=market_cap_desc&per_page=12&page=${page}&sparkline=false`
        ).then((res) => {
            setData((prev) => {
        ...
        <>
            <section className='container'>
                <form>
                    ...
                    <input type='search' placeholder='search coins' value={search} 
                                ...
                                <Link className='link' to={`coin/${d.id}`} key={i}>
                                    <div className='box_coins' >
                                        ...
                                        <div className='right-box-coins'>
                                            ...
                                            <h4 style={{ color: d.market_cap_change_percentage_24h 
                                                < 0 ? "red" : "green" }}>
                                                    {d.market_cap_change_percentage_24h
                                                    .toFixed(1)}%</h4>

                                            <h4>${d.total_volume.toLocaleString()}</h4>

                                            <h4 className='hide-mobile' style={{ marginLeft: 
                                                '.6rem' }}>
